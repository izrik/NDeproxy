...
NDeproxy (or just "deproxy") is a tool for performing high-level, black-box, functional/regression testing of proxies, and other HTTP applications. It is written in C#. It is meant to be incorporated into unit tests for functional testing.
...
But this is just scratching the surface. The `NDeproxy` namespace contains additional tools and utilities for custom server responses, mocking, testing multiple endpoints, and more.
